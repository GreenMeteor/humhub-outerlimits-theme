...
<div class="container" style="text-align: center;">
    ...
    <div class="panel panel-default animated bounceIn" id="login-form"
        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-md-4">
                    <?= Html::submitButton(Yii::t('UserModule.views_auth_login', 'Sign in'), ['id' => 'login-button', 'data-ui-loader' => "", 'class' => 'btn btn-large btn-primary']); ?>
                </div>
                <?= Html::resetButton(Yii::t('UserModule.views_auth_login', 'Reset'), ['id' => 'reset-button', 'class' => 'btn btn-large btn-primary']); ?>
    ...
    <?php if ($canRegister) : ?>
        <div id="register-form"
            ...
            <div class="panel-body">
                ...
                <hr>
                <?= Html::submitButton(Yii::t('UserModule.views_auth_login', 'Register'), ['class' => 'btn btn-primary', 'data-ui-loader' => '']); ?>
